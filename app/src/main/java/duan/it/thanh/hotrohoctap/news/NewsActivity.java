package duan.it.thanh.hotrohoctap.news;
...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bản Tin Giáo Dục");
        ...
        getDataTask.execute("https://vnexpress.net/rss/giao-duc.rss");
    }
    class GetDataTask extends AsyncTask<String, Long, List<News>> {
        ...
        protected void onPostExecute(List<News> news) {
            ...
            Toast.makeText(NewsActivity.this,"Size :" + news.size(),
